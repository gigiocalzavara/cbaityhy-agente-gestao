WITH procedimentos AS (
  SELECT date_trunc('month', o.dt_inicial_atendimento)::date AS competencia,
         ...
         replace(cbo.nu_cbo, '-', '') AS cbo, proc.codigo
  ...
  SELECT * FROM procedimentos WHERE
    (cbo IN ('322405','322425') AND codigo IN ('0101020058','0101020066','0101020074','0101020082','0101020104','0101020120'))
    OR (cbo IN ('223208','223293','223272') AND codigo IN (
      '0101020058','0101020066','0101020074','0101020082','0101020090','0101020104','0101020120','0414020138',
      '0307010015','0307010031','0307010066','0307010074','0307010082','0307010104','0307010112','0307010120','0307010147','0307010155',
      '0307020010','0307020029','0307020070','0307030024','0307030040','0307030059','0307030067','0307030075','0307030083','0307050017'
    ))
)
SELECT competencia, nu_ine, equipe,
       count(*) FILTER (WHERE codigo IN ('0101020058','0101020066','0101020074','0101020082','0101020104','0101020120','0307030040')) AS procedimentos_preventivos,
       count(*) AS total_procedimentos_odontologicos,
       round(count(*) FILTER (WHERE codigo IN ('0101020058','0101020066','0101020074','0101020082','0101020104','0101020120','0307030040'))::numeric / NULLIF(count(*), 0) * 100, 2) AS perc_preventivos
FROM elegiveis GROUP BY competencia, nu_ine, equipe
ORDER BY perc_preventivos DESC NULLS LAST, equipe;
